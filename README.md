...
- `GET /api/stats` — estatísticas do relay: carteiras, mensagens de chat, chats, sinais de sistema, movimentação financeira por ativo e grafo de interações agregado (sem auth).
